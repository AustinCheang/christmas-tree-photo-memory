...
export const Experience: React.FC<ExperienceProps> = ({ mode, handPosition, uploadedPhotos, twoHandsDetected }) => {
  ...
  return (
    <>
      ...
      <group position={[0, -5, 0]}>
        <Foliage mode={mode} count={30000} />
        <Ornaments mode={mode} count={600} />
        <Polaroids mode={mode} uploadedPhotos={uploadedPhotos} twoHandsDetected={twoHandsDetected} />
        <TreeStar mode={mode} />
