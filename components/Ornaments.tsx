...
export const Ornaments: React.FC<OrnamentsProps> = ({ mode, count }) => {
  ...
  return (
    <>
      ...
      <instancedMesh ref={ballsRef} args={[undefined, undefined, ballsData.length]} frustumCulled={false}>
      ...
      <instancedMesh ref={giftsRef} args={[undefined, undefined, giftsData.length]} frustumCulled={false}>
      ...
      <instancedMesh ref={lightsRef} args={[undefined, undefined, lightsData.length]} frustumCulled={false}>
